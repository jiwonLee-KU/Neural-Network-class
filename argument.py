...
def arg():
    ...
    parser.add_argument('--net', type=str, default='EEGNet')
    parser.add_argument('--label', type=str, default='0,1,2,3')
    parser.add_argument('--gpu', type=int, default=0)
    parser.add_argument('--sch', type=str, default='exp')
    parser.add_argument('--gamma', type=float, default=0.999)
    parser.add_argument('--epochs', type=int, default=150)
    parser.add_argument('-lr', type=float, default=2e-4)
    parser.add_argument('--stamp', type=str, default='baseline')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('-wd', type=float, default=1e-5)
    # parser.add_argument('--train_subject', type=int, default=1)
    parser.add_argument('--CAR', type=bool, default=False)
